...
const companyInfo = [
  ...
  { label: '所在地',     value: '〒879-0007 大分県架空市堺市1-2-3' },
...
// 沿革：2031年が混入
const history = [
  { year: '2019', event: '架空市堺市にて創業。代表・小布結 志文が職人3名とともに設立。' },
      ...
      <section>
        ...
        <div className="bg-earth-100 aspect-video flex items-center justify-center text-earth-400 text-sm">
          <div className="text-center">
            <p className="font-serif text-base text-earth-600 mb-2">大分県架空市堺市1-2-3</p>
